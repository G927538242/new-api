...
func SetRelayRouter(router *gin.Engine) {
	...
	modelsRouter.Use(middleware.RequireCertification())
	{
	...
	geminiRouter.Use(middleware.RequireCertification())
	{
	...
	geminiCompatibleRouter.Use(middleware.RequireCertification())
	{
	...
	playgroundRouter.Use(middleware.UserAuth(), middleware.RequireCertification(), middleware.Distribute())
	{
	...
	relayV1Router.Use(middleware.RequireCertification())
	...
	relaySunoRouter.Use(middleware.TokenAuth(), middleware.RequireCertification(), middleware.Distribute())
	{
	...
	relayGeminiRouter.Use(middleware.RequireCertification())
...
func registerMjRouterGroup(relayMjRouter *gin.RouterGroup) {
	...
	relayMjRouter.Use(middleware.TokenAuth(), middleware.RequireCertification(), middleware.Distribute())
	{
